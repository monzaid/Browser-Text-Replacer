 ...
 * 支持 MutationObserver 动态检测和 iframe 支持 (ESM)
 */

import { EditableSelectors } from '../../shared/constants.js';
import { triggerEvent } from '../../shared/utils.js';
 ...
 */
export function findAllEditableElements() {
  const results = [];
